  ...
  return(
    <div style={{maxWidth:640}}>
      ...
      <Section id="economy" icon="" title="Hero Economy — Sign, Develop, Sell">
        ...
        <p style={{margin:"0 0 8px"}}>The <b style={{color:"#8A6D3B"}}>Career Arc</b> panel in each hero's detail shows exactly where they are: Prospect → Rising → Peak → Fading → Veteran. Sell at Peak. Once Fading, bids drop to 60% of value.</p>
        <p style={{margin:0}}>A hero who sees out the whole Veteran stage <b style={{color:"#9A5B2B"}}>retires</b> with a ceremony — and can pass on their wisdom: choose one hero as their <b>mentee</b> and they gain +10 XP/week for a full season, on the field or the bench. With the Hall of Legends built, every retired hero also lifts squad morale each week, scaled by the level they retired at. Full careers run ~12 seasons, so retirement is a late-dynasty reward — keeping a beloved veteran to the end is a real alternative to selling them off in decline.</p>
      </Section>
